...
{
	public virtual TEntity Get(long id) => GetOrDefault(id) ?? throw new LSCoreNotFoundException();
	...
	public virtual void Insert(TEntity entity) => Insert([entity]);
	...
	public virtual void SoftDelete(long id) => SoftDelete(Get(id));

	public virtual void HardDelete(long id) => HardDelete(Get(id));

	public virtual void SoftDelete(TEntity entity) => SoftDelete([entity]);

	public virtual void HardDelete(TEntity entity) => HardDelete([entity]);
